...
const REFRESH_TYPE = 'movieComingsoon/onRefresh';
const LOAD_MORE_TYPE = 'movieComingsoon/onLoadMore';

const mapStateToProps = ({ movieComingsoon }: RootState) => {
  return {
    dataList: movieComingsoon.dataList,
    refreshState: movieComingsoon.refreshState,
    page: movieComingsoon.page,
  };
};

function MovieComingsoonPage() {
...
export default MovieComingsoonPage;
